...
for(let i=0;i<graduates.length;i++){
  if(graduates[i]['university'].includes("Uni")){
    uni.push(graduates[i]['first_name']);
  }
}
console.log(uni);
...
*/
const animalNames = [];
let combineNames = zooAnimals.forEach(animal => {
...
let lowerName = zooAnimals.map((animal)=>{
...
// for(let i=0;i<graduates.length;i++){
//   universityInfo.push(`${graduates[i]['first_name']} ${graduates[i]['email']}`);
// }
// console.log(universityInfo);
// //---------------------------------------------------------------------------------------
// const contactInfo = [];
// let info = graduates.forEach( (person)=>{
//   contactInfo.push(`${person['first_name']} ${person['email']}`);
// });
// console.log(contactInfo);
// //---------------------------------------------------------------------------------------
// const uni = [];
// let isUniversity = graduates.forEach((person)=>{
//   if(person['university'].includes("Uni")){
//     uni.push(person['first_name']);
//   }
// });
// console.log(uni);
...
//questions---------
//for Request three, I had to use .include(), I tried creating my own function but i was having too strict of a case
